...
Here you will find instructions to complete many if not all of the reoccurring data reports and submissions the data analyst is responsible for producing.
...
Every quarter, mental health agencies in Ontario are required to submit data. ASK NICK FOR SOME WORDAGE FOR HERE.
...
### Submit BI Data to our lead agency site (the first step in any BI submission) {#LeadAgencyQuarterly}
